        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/garden" className="glass-btn flex items-center justify-center gap-2 group">
                Explore Garden 
                <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link to="/plant-identification" className="glass-btn-outline flex items-center justify-center gap-2">
                Identify Plants
              </Link>
            </div>
          </div>
