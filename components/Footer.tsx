        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-gray-400 hover:text-herb-400 transition-colors">Home</Link>
              </li>
              <li>
                <Link href="/garden" className="text-gray-400 hover:text-herb-400 transition-colors">Virtual Garden</Link>
              </li>
              <li>
                <Link href="/medicines" className="text-gray-400 hover:text-herb-400 transition-colors">Herbal Medicines</Link>
              </li>
              <li>
                <Link href="/plant-identification" className="text-gray-400 hover:text-herb-400 transition-colors">Identify Plants</Link>
              </li>
              <li>
                <Link href="/disease-identification" className="text-gray-400 hover:text-herb-400 transition-colors">Identify Diseases</Link>
              </li>
            </ul>
          </div>
